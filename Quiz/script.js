...
function optionClick(e) {
    ...
    if (questions[currentQuestion].answer === clikOption) {
        correntAnswers++;
    }
...
function finishQuiz() {
    ...
    document.querySelector('.scoreText2').innerHTML = `Voce respondeu ${questions.length} questões e acertou ${correntAnswers} `
